...
#define POT_READ_MIN_2  95
#define POT_READ_MAX_2  895
...
float Ki_joint2 = 0.4;
float Kd_joint2 = 0.1;
float Kp_joint2_dead_zone = 30.0;

int   joint2_pwm_limitter_H  = 450;     //pwmの最大値
int   joint2_pwm_limitter_L  = -450;    //pwmの最小値
